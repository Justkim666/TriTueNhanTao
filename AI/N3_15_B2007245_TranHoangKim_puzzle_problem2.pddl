(define (problem hard1)
    (:domain strips-sliding-title)
        ...
        (:init   (title t1) (title t2) (title t3) (title t4) (title t5)
                 ...
                 (blank x2 y2) (at t8 x2 y1) (at t7 x3 y2) (at t6 x2 y3) (at t4 x3 y1)
                 (at t1 x1 y1) (at t2 x3 y3) (at t5 x1 y2) (at t3 x1 y3))
        (:goal (and (at t1 x1 y1) (at t2 x1 y2) (at t3 x1 y3) (at t4 x2 y3)
                     (at t5 x3 y3) (at t6 x3 y2) (at t7 x3 y1) (at t8 x2 y1))))